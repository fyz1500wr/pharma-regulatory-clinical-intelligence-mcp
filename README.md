...
| `docs/dashboard_query_filter_contract.md` | Defines the MVP dashboard query/filter contract that maps approved runtime tool outputs to future dashboard filters, display caveats, and row fields without implementing dashboard rendering or source expansion. |
...
| `docs/mock_dashboard_record_examples.md` | Provides fictional mock dashboard record examples and static artifact acceptance criteria without implementing dashboard rendering or artifact generation. |
...
| `docs/regulatory_clinical_digest_example_memo.md` | Provides a controlled example memo showing how to preserve source limitations and sponsor-association caveats. |
...
| `docs/cmc_submission_readiness_mock_inventory.md` | Provides a non-confidential CMC readiness mock inventory and Module 3 gap matrix dry-run for validating PM follow-up usefulness. |
| `docs/cmc_submission_readiness_input_template.md` | Provides a reusable CMC readiness input template and prompt pack for consistent Module 3 gap, vendor follow-up, and critical path review. |
